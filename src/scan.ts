import type { AddedLine } from "./diff";
import {
  PATTERN_RULES,
...
export interface Finding {
  ...
  /** The raw matched secret substring. Kept in-memory only — every output path (comment, logs, triage payloads) must redact this before it leaves the process. */
  secret: string;
